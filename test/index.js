    ...
    it ( 'supports traversing for default values', t => {
      ...
      const schema = object ({
        deep: object ({
          ...
          bigint: bigint ().nillable ().default ( 'bigint' ),
          boolean: boolean ().default ( 'boolean' ).nillable (),
          nillable: nillable ( number () ).default ( 'nillable' ),
          null: _null ().default ( 'null' ),
          nullable: nullable ( number () ).default ( 'nullable' ),
          number: number ().default ( 'number' ).nullable (),
          object: object ().nullable ().default ( 'object' ),
          optional: optional ( number () ).default ( 'optional' ),
          string: string ().default ( 'string' ).optional (),
          symbol: symbol ().optional ().default ( 'symbol' ),
    ...
    it ( 'supports traversing for descriptions', t => {
      ...
      const schema = object ({
        deep: object ({
          ...
          bigint: bigint ().nillable ().description ( 'bigint' ),
          boolean: boolean ().description ( 'boolean' ).nillable (),
          nillable: nillable ( number () ).description ( 'nillable' ),
          null: _null ().description ( 'null' ),
          nullable: nullable ( number () ).description ( 'nullable' ),
          number: number ().description ( 'number' ).nullable (),
          object: object ().nullable ().description ( 'object' ),
          optional: optional ( number () ).description ( 'optional' ),
          string: string ().description ( 'string' ).optional (),
          symbol: symbol ().optional ().description ( 'symbol' ),
